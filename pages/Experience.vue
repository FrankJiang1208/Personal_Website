...
import iphoneImg from '~/assets/code.jpg'
import laptopImg from '~/assets/geo.jpg'
import personImg from '~/assets/mac.jpg'
export default {
  data() {
    return {
      projects: [
        {
          link:{url: 'https://github.com/FrankJiang1208/Job-Market-Analysis/'},
          image: {
            url: iphoneImg
          },
          title: 'Projects'
